...
# pragma: no cover  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2WVU1S2VBPT06M2IwOTYwNDA=
...
# pylint: disable  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2WVU1S2VBPT06M2IwOTYwNDA=
        ...
        if tcp_ports:
            ...
            for p in sorted(tcp_ports, key=lambda x: x["port"]):
                ...
                if svc_prod:
                    ...
                    line += ")"
                lines.append(line)
# noqa  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2WVU1S2VBPT06M2IwOTYwNDA=
...
def main():
    ...
    output_file = None
    show_summary = False
# fmt: off  My80OmFIVnBZMlhva2FQbHNJL21tS1U2WVU1S2VBPT06M2IwOTYwNDA=
