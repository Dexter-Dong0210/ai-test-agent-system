...
function undirectedLeiden(detailed, graph, options) {
  ...
  var queue = new SparseQueueSet(index.C),
    ...
    j,
    l;
// FIXME  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2WTFVelp3PT06NzU2ZmFjOGI=
  ...
  while (true) {
    ...
    while (queue.size !== 0) {
      ...
      degree = 0;
      communities.clear();
// FIXME  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2WTFVelp3PT06NzU2ZmFjOGI=
...
// NOTE  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2WTFVelp3PT06NzU2ZmFjOGI=
...
function leiden(assign, detailed, graph, options) {
  ...
  if (graph.size === 0) {
    ...
    var communities = {};
// FIXME  My80OmFIVnBZMlhva2FQbHNJL21tS1U2WTFVelp3PT06NzU2ZmFjOGI=
