 ...
 */
// @ts-expect-error  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2Y0cwNVFnPT06MTJhOWM0NDg=
...
// TODO  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2Y0cwNVFnPT06MTJhOWM0NDg=
...
// TODO  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2Y0cwNVFnPT06MTJhOWM0NDg=
  ...
  if (error) {
    return (
      <div className="my-3 rounded-lg border border-rose-500/30 bg-rose-500/10 p-4">
        <div className="mb-2 flex items-center gap-2 text-sm text-rose-500 dark:text-rose-300">
          <AlertTriangle className="h-4 w-4" />
          <span className="font-medium">Diagram Error</span>
        </div>
        <pre className="font-mono text-xs whitespace-pre-wrap text-rose-600/70 dark:text-rose-200/70">{error}</pre>
...
// TODO  My80OmFIVnBZMlhva2FQbHNJL21tS1U2Y0cwNVFnPT06MTJhOWM0NDg=
