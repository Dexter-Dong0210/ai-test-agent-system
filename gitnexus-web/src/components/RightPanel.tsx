 ...
 */
// NOTE  MC8yOmFIVnBZMlhva2FQbHNJL21tS1U2YVZGU1Z3PT06MjI4NjdiMDg=
    ...
    <aside className="relative z-30 flex w-[40%] max-w-[600px] min-w-[400px] flex-shrink-0 animate-slide-in flex-col border-l border-border-subtle bg-deep">
      ...
      {activeTab === 'chat' && (
        <div className="relative flex flex-1 flex-col overflow-hidden">
          ...
          {/* Status / errors */}
          {agentError && (
            <div className="flex items-center gap-2 border-b border-rose-500/30 bg-rose-500/10 px-4 py-3 text-sm text-rose-600 dark:text-rose-100">
          ...
          <div ref={scrollContainerRef} className="scrollbar-thin flex-1 overflow-y-auto p-4">
            {chatMessages.length === 0 ? (
              <div className="flex h-full flex-col items-center justify-center px-4 text-center">
                ...
                <h3 className="mb-2 text-base font-medium">向我提问</h3>
                <p className="mb-5 text-sm leading-relaxed text-text-secondary">
                  我可以帮您理解架构、查找函数或解释连接关系。
                </p>
          ...
          <div className="border-t border-border-subtle bg-surface p-3">
            ...
            {!isAgentReady && !isAgentInitializing && (
              <div className="mt-2 flex items-center gap-2 text-xs text-amber-600 dark:text-amber-200">
...
// TODO  MS8yOmFIVnBZMlhva2FQbHNJL21tS1U2YVZGU1Z3PT06MjI4NjdiMDg=
