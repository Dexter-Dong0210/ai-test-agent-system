 ...
 */
// @ts-expect-error  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2YlZCTlZBPT06NjE5NGNmNGE=
...
// NOTE  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2YlZCTlZBPT06NjE5NGNmNGE=

export interface GraphCanvasHandle {
  focusNode: (nodeId: string) => void;
}
// @ts-expect-error  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2YlZCTlZBPT06NjE5NGNmNGE=
...
export const GraphCanvas = forwardRef<GraphCanvasHandle>((_, ref) => {
  ...
  return (
    <div className="relative h-full w-full bg-void">
      {/* Background gradient - 使用 CSS 变量支持主题切换 */}
      ...
      {isLayoutRunning && (
        <div className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 animate-fade-in items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/20 px-3 py-1.5 backdrop-blur-sm">
          ...
          <span className="text-xs font-medium text-emerald-600 dark:text-emerald-400">Layout optimizing...</span>
        </div>
      )}
      ...
      <div className="absolute top-4 right-4 z-20">
        <button
          ...
          className={
            isAIHighlightsEnabled
              ? 'flex h-10 w-10 items-center justify-center rounded-lg border border-cyan-500/40 bg-cyan-500/15 text-cyan-700 dark:text-cyan-200 transition-colors hover:border-cyan-500/60 hover:bg-cyan-500/20'
...
// FIXME  My80OmFIVnBZMlhva2FQbHNJL21tS1U2YlZCTlZBPT06NjE5NGNmNGE=
