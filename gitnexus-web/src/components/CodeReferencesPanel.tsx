 ...
 */
// FIXME  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2UmtoTk1RPT06ZjFmNzJkM2E=
...
// eslint-disable  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2UmtoTk1RPT06ZjFmNzJkM2E=
...
// FIXME  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2UmtoTk1RPT06ZjFmNzJkM2E=
            ...
            <div ref={selectedViewerRef} className="scrollbar-thin min-h-0 flex-1 overflow-auto">
              {isLoadingFile ? (
                <div className="flex items-center justify-center gap-2 py-8 text-text-muted">
                  ...
                  <span className="text-sm">加载源码...</span>
                </div>
              ) : selectedFileContent ? (
                <SyntaxHighlighter
                ...
                <div className="px-3 py-3 text-sm text-text-muted">
                  {selectedIsFile ? (
                    <>
                      内存中无法获取{' '}
                      <span className="font-mono">{selectedFilePath}</span> 的代码
                    </>
                  ) : (
                    <>选择文件节点以预览其内容。</>
                  )}
          ...
          <div className="flex min-h-0 flex-1 flex-col">
            ...
            <div className="flex items-center gap-2 border-b border-cyan-500/20 bg-gradient-to-r from-cyan-500/8 to-teal-500/5 px-3 py-2">
              <div className="flex items-center gap-1.5 rounded-md border border-cyan-500/25 bg-cyan-500/15 px-2 py-0.5">
                ...
                <span className="text-[10px] font-semibold tracking-wide text-cyan-700 dark:text-cyan-300 uppercase">
                  AI 引用
                </span>
              </div>
              <span className="ml-1 text-xs text-text-muted">
                {aiReferences.length} 个引用
              </span>
            </div>
                    ...
                    >
                      ...
                      <div className="overflow-x-auto">
                        {content ? (
                          ...
                          <div className="px-3 py-3 text-sm text-text-muted">
                            内存中无法获取{' '}
                            <span className="font-mono">{ref.filePath}</span> 的代码
                          </div>
                        )}
                      </div>
                    </div>
...
// TODO  My80OmFIVnBZMlhva2FQbHNJL21tS1U2UmtoTk1RPT06ZjFmNzJkM2E=
