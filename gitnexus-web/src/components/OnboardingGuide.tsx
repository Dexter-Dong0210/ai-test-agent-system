...
// ── Design constants ─────────────────────────────────────────────────────────
// TODO  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2WjFJM1ZRPT06YTgzMTY2YTA=
...
// NOTE  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2WjFJM1ZRPT06YTgzMTY2YTA=
...
// FIXME  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2WjFJM1ZRPT06YTgzMTY2YTA=
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 text-[11px] text-text-muted">检测到后将自动连接</p>
      </div>
    </div>
  );
}
...
// FIXME  My80OmFIVnBZMlhva2FQbHNJL21tS1U2WjFJM1ZRPT06YTgzMTY2YTA=
    ...
    <div className="relative animate-fade-in overflow-hidden rounded-3xl border border-border-default bg-surface p-7">
      ...
      <div className="relative space-y-5">
        ...
        <StepRow
          ...
          number={1}
          title="复制命令"
          description={isPolling ? undefined : '点击终端中的图标进行复制。'}
        >
        ...
        <StepRow
          state={step2State}
          number={2}
          title={isPolling ? '等待服务器启动' : '粘贴并在终端中运行'}
          description={
            isPolling ? undefined : '在项目根目录打开终端，粘贴命令并按回车。'
          }
        >
