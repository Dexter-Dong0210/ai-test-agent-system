 ...
 */
// NOTE  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxeFl3PT06NjVkMDFlMTg=
...
// eslint-disable  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxeFl3PT06NjVkMDFlMTg=
...
// NOTE  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxeFl3PT06NjVkMDFlMTg=
...
// TODO  My80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxeFl3PT06NjVkMDFlMTg=
      ...
      a: ({ href, children, ...props }: any) => {
        ...
        if (hrefStr.startsWith('code-ref:') || hrefStr.startsWith('node-ref:')) {
          ...
          const colorParams = isNodeRef
            ? 'border border-amber-500/50 bg-amber-500/10 !text-amber-600 visited:!text-amber-600 hover:bg-amber-500/15 hover:border-amber-500/70'
            : 'border border-cyan-500/50 bg-cyan-500/10 !text-cyan-600 visited:!text-cyan-600 hover:bg-cyan-500/15 hover:border-cyan-500/70';
