...
# fmt: off  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2T0hwa1ZBPT06NGI4M2ZhNjY=
...
# noqa  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2T0hwa1ZBPT06NGI4M2ZhNjY=
    ...
    async def _cursor(
        ...
        async with self.lock, _ainternal.get_connection(self.conn) as conn:
            if self.pipe:
                ...
                async with conn.cursor(binary=True, row_factory=dict_row) as cur:
                    yield cur
# type: ignore  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2T0hwa1ZBPT06NGI4M2ZhNjY=
...
# pragma: no cover  My80OmFIVnBZMlhva2FQbHNJL21tS1U2T0hwa1ZBPT06NGI4M2ZhNjY=
