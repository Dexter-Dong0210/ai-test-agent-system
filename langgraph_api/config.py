...
# noqa  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2WWs1YWN3PT06MWM1NTc2YTA=
...
# fmt: off  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2WWs1YWN3PT06MWM1NTc2YTA=
...
# noqa  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2WWs1YWN3PT06MWM1NTc2YTA=
...
GRPC_SERVER_MAX_RECV_MSG_BYTES = env(
    "GRPC_SERVER_MAX_RECV_MSG_BYTES", cast=int, default=100 * 1024 * 1024
)
GRPC_SERVER_MAX_SEND_MSG_BYTES = env(
    "GRPC_SERVER_MAX_SEND_MSG_BYTES", cast=int, default=100 * 1024 * 1024
)
GRPC_CLIENT_MAX_RECV_MSG_BYTES = env(
    "GRPC_CLIENT_MAX_RECV_MSG_BYTES", cast=int, default=100 * 1024 * 1024
)
GRPC_CLIENT_MAX_SEND_MSG_BYTES = env(
    "GRPC_CLIENT_MAX_SEND_MSG_BYTES", cast=int, default=100 * 1024 * 1024
)
...
# fmt: off  My80OmFIVnBZMlhva2FQbHNJL21tS1U2WWs1YWN3PT06MWM1NTc2YTA=
