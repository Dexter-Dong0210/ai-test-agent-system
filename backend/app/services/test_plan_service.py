...
class TestPlanService:
    ...
    async def get_test_plans(
        ...
        return result, total
# fmt: off  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2T1doVmF3PT06Zjc2YjViYjQ=
...
# type: ignore  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2T1doVmF3PT06Zjc2YjViYjQ=
    ...
    async def get_test_runs_for_plan(
        ...
        if not test_plan or test_plan.project_id != project.id:
            raise NotFoundException(resource_type="测试计划", resource_id=test_plan_identifier)
# type: ignore  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2T1doVmF3PT06Zjc2YjViYjQ=
    ...
    async def delete_test_plan(
        ...
        if not test_plan or test_plan.project_id != project.id:
            raise NotFoundException(resource_type="测试计划", resource_id=test_plan_identifier)
# pylint: disable  My80OmFIVnBZMlhva2FQbHNJL21tS1U2T1doVmF3PT06Zjc2YjViYjQ=
