...
# fmt: off  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2VUZCcU9RPT06ZjViNDJiZmI=
    ...
    @cache_result(ttl=300, key_prefix="folders")
    ...
    async def get_root_folders(
        ...
        from app.models.folder_type import FolderType
# pragma: no cover  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2VUZCcU9RPT06ZjViNDJiZmI=
    ...
    async def get_sub_folders(
        ...
        if not folder or folder.project_id != project.id:
            raise NotFoundException(resource_type="文件夹", resource_id=str(folder_id))
# fmt: off  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2VUZCcU9RPT06ZjViNDJiZmI=
...
# type: ignore  My80OmFIVnBZMlhva2FQbHNJL21tS1U2VUZCcU9RPT06ZjViNDJiZmI=
