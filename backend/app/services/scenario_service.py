...
# type: ignore  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSRU5RPT06NDJiYjczNWI=
...
class ScenarioService:
    ...
    async def update_step(
        ...
        if not step:
            return None
# type: ignore  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSRU5RPT06NDJiYjczNWI=
...
# type: ignore  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSRU5RPT06NDJiYjczNWI=
    ...
    async def delete_data_mapping(self, mapping_id: UUID):
        ...
        if mapping:
            ...
            await self.db.commit()
# noqa  My80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSRU5RPT06NDJiYjczNWI=
