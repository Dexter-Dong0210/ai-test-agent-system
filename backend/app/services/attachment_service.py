...
# pylint: disable  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2U0c0MmNnPT06ZDU4NjM1YzA=
...
# pylint: disable  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2U0c0MmNnPT06ZDU4NjM1YzA=
    ...
    async def get_test_result_attachments(
        ...
        """获取测试结果附件列表"""
        from uuid import UUID as PyUUID
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2U0c0MmNnPT06ZDU4NjM1YzA=
    ...
    async def delete_test_result_attachment(
        ...
        if not test_result:
            raise NotFoundException(resource_type="测试结果", resource_id=test_result_id)
# noqa  My80OmFIVnBZMlhva2FQbHNJL21tS1U2U0c0MmNnPT06ZDU4NjM1YzA=
