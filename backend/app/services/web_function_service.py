...
# noqa  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2YUZSTk13PT06M2ZhZDhiYzE=
...
class WebFunctionService:
    ...
    async def delete_web_function(
        ...
        if not web_function:
            raise NotFoundException(resource_type="Web 功能", resource_id=function_id)
# noqa  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2YUZSTk13PT06M2ZhZDhiYzE=
...
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2YUZSTk13PT06M2ZhZDhiYzE=
    ...
    async def get_sub_function_artifacts(
        ...
        if not web_sub_function:
            raise NotFoundException(resource_type="Web 子功能", resource_id=sub_function_id)
# noqa  My80OmFIVnBZMlhva2FQbHNJL21tS1U2YUZSTk13PT06M2ZhZDhiYzE=
