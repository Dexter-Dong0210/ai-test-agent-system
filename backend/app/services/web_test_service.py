...
# noqa  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2UldSclpRPT06MzRhNjM0YjA=
    ...
    async def update_web_test(
        ...
        if not web_test or web_test.project_id != project.id:
            raise NotFoundException(resource_type="Web 测试", resource_id=web_test_id)
# fmt: off  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2UldSclpRPT06MzRhNjM0YjA=
    ...
    async def run_web_test(
        ...
        if not web_test or web_test.project_id != project.id:
            raise NotFoundException(resource_type="Web 测试", resource_id=web_test_id)
# type: ignore  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2UldSclpRPT06MzRhNjM0YjA=
        ...
        async with async_session_factory() as session:
            ...
            try:
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    ...
                    await session.commit()
# type: ignore  My80OmFIVnBZMlhva2FQbHNJL21tS1U2UldSclpRPT06MzRhNjM0YjA=
