...
# pragma: no cover  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxb1NBPT06OGZhMjMyMzQ=
...
from app.services.cache_service import cache_result, invalidate_cache, cache
    ...
    async def get_project(self, project_identifier: str) -> ProjectInfo:
        ...
        for d in data:
            if d["project"].id == project.id:
                ...
                break
# type: ignore  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxb1NBPT06OGZhMjMyMzQ=
...
# type: ignore  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxb1NBPT06OGZhMjMyMzQ=
...
# pragma: no cover  My80OmFIVnBZMlhva2FQbHNJL21tS1U2V2sxb1NBPT06OGZhMjMyMzQ=
