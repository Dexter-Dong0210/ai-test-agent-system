...
# fmt: off  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2ZUdOS1RnPT06M2E1ZTE2ZGE=
...
class TestRunSchedulerService:
    ...
    def pause_schedule(self, schedule_id: str) -> None:
        ...
        try:
            ...
            pass
# noqa  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2ZUdOS1RnPT06M2E1ZTE2ZGE=
    ...
    async def _execute_scheduled_run(self, schedule_id: str) -> None:
        ...
        async with async_session_factory() as session:
            ...
            test_run = TestRun(
                ...
                name=schedule.name,  # 使用调度名称作为测试运行名称
...
# type: ignore  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2ZUdOS1RnPT06M2E1ZTE2ZGE=
...
# type: ignore  My80OmFIVnBZMlhva2FQbHNJL21tS1U2ZUdOS1RnPT06M2E1ZTE2ZGE=
