...
# pragma: no cover  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2T0RKUFZ3PT06OGVkMWE1MTM=
...
# pragma: no cover  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2T0RKUFZ3PT06OGVkMWE1MTM=
    ...
    async def count_by_project_with_filters(
        ...
        if updated_after:
            query = query.where(TestCase.updated_at >= updated_after)
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2T0RKUFZ3PT06OGVkMWE1MTM=
    ...
    async def add_tag_to_test_case(
        ...
        if not existing:
            ...
            await self.session.flush()
# noqa  My80OmFIVnBZMlhva2FQbHNJL21tS1U2T0RKUFZ3PT06OGVkMWE1MTM=
