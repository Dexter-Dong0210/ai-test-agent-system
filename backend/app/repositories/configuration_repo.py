...
# fmt: off  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2YTBZMFN3PT06NDk1NDg2YWU=
...
# pragma: no cover  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2YTBZMFN3PT06NDk1NDg2YWU=
...
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2YTBZMFN3PT06NDk1NDg2YWU=
    ...
    async def get_by_ids(self, config_ids: list[int]) -> list[Configuration]:
        ...
        result = await self.session.execute(stmt)
        return list(result.scalars().all())
# pragma: no cover  My80OmFIVnBZMlhva2FQbHNJL21tS1U2YTBZMFN3PT06NDk1NDg2YWU=
