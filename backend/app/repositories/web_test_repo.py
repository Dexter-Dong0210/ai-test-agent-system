...
# noqa  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2UzFOTFFnPT06NjZlMjAyNjQ=
...
# pylint: disable  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2UzFOTFFnPT06NjZlMjAyNjQ=
...
class WebTestRunRepository(BaseRepository[WebTestRun]):
    ...
    async def get_by_web_test(
        ...
        query = query.offset(offset).limit(limit)
# type: ignore  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2UzFOTFFnPT06NjZlMjAyNjQ=
...
# pragma: no cover  My80OmFIVnBZMlhva2FQbHNJL21tS1U2UzFOTFFnPT06NjZlMjAyNjQ=
