...
class WebFunctionRepository(BaseRepository[WebFunction]):
    """Web 功能仓储类"""
# fmt: off  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSNVlnPT06ZGFmYWZhNjE=
    ...
    async def get_by_folder(
        ...
        query = query.order_by(WebFunction.sort_order, WebFunction.created_at.desc())
        query = query.offset(offset).limit(limit)
# pylint: disable  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSNVlnPT06ZGFmYWZhNjE=
...
class WebSubFunctionRepository(BaseRepository[WebSubFunction]):
    ...
    async def get_by_id_with_relations(self, id: UUID) -> Optional[WebSubFunction]:
        ...
        return result.scalar_one_or_none()
# noqa  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSNVlnPT06ZGFmYWZhNjE=
    ...
    async def get_by_folder(
        ...
        return items, total
# fmt: off  My80OmFIVnBZMlhva2FQbHNJL21tS1U2TWtSNVlnPT06ZGFmYWZhNjE=
