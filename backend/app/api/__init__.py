...
# pylint: disable  MC8yOmFIVnBZMlhva2FQbHNJL21tS1U2ZG5CSVJRPT06ZTFmNmViMTM=

from .v2 import projects, folders, test_cases, test_runs, test_results, attachments, configurations, test_plans, documents, api_tests, api_tests_extended, api_endpoints, scenarios, web_tests, web_functions, pentests, mcp_proxy, android_tests, cache, reports
...
api_router.include_router(reports.router, tags=["测试报告"])
api_router.include_router(reports.public_router, tags=["公开报告"])

__all__ = ["api_router"]
# fmt: off  MS8yOmFIVnBZMlhva2FQbHNJL21tS1U2ZG5CSVJRPT06ZTFmNmViMTM=
