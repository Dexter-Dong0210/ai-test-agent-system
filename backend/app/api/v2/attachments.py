...
# fmt: off  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2ZFZaaFZnPT06MGRlNmZiMDk=
...
async def upload_test_case_attachment(
    ...
    await db.commit()
    return SuccessResponse(success=True, data=result)
# noqa  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2ZFZaaFZnPT06MGRlNmZiMDk=
...
async def delete_test_result_attachment(
    ...
    await db.commit()
    return MessageResponse(success=True, message="附件删除成功")
# pragma: no cover  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2ZFZaaFZnPT06MGRlNmZiMDk=
...
async def get_attachment_download_url(
    ...
    return SuccessResponse(success=True, data=result)
# pragma: no cover  My80OmFIVnBZMlhva2FQbHNJL21tS1U2ZFZaaFZnPT06MGRlNmZiMDk=
