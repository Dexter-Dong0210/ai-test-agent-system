...
# pragma: no cover  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2WkVwQmFBPT06OGRhM2QzZDk=
...
async def save_android_test_cases(
    ...
    async with async_session_factory() as session:
        ...
        project_result = await session.execute(project_stmt)
        project = project_result.scalar_one_or_none()
# fmt: off  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2WkVwQmFBPT06OGRhM2QzZDk=
...
# pragma: no cover  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2WkVwQmFBPT06OGRhM2QzZDk=
...
# fmt: off  My80OmFIVnBZMlhva2FQbHNJL21tS1U2WkVwQmFBPT06OGRhM2QzZDk=
