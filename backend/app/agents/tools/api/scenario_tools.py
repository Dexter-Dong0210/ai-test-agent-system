...
# pragma: no cover  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2VUVaWE1BPT06Yjc3ODkyZWQ=
...
async def update_test_scenario(
    ...
    async with async_session_factory() as session:
        try:
            ...
            await session.commit()
            await session.refresh(scenario)
# pragma: no cover  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2VUVaWE1BPT06Yjc3ODkyZWQ=
...
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2VUVaWE1BPT06Yjc3ODkyZWQ=
...
async def add_data_mapping(
    ...
    async with async_session_factory() as session:
        try:
            ...
            step_result = await session.execute(step_stmt)
            step = step_result.scalar_one_or_none()
# type: ignore  My80OmFIVnBZMlhva2FQbHNJL21tS1U2VUVaWE1BPT06Yjc3ODkyZWQ=
