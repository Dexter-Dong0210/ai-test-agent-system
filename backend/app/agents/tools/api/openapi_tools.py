...
# noqa  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2YldaRU53PT06NDIxOGJjNjA=
...
# fmt: off  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2YldaRU53PT06NDIxOGJjNjA=
...
async def get_multiple_endpoints_details(
    ...
    async for db in get_db():
        try:
            ...
            endpoint_result = await db.execute(endpoint_stmt)
            endpoints = endpoint_result.scalars().all()
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2YldaRU53PT06NDIxOGJjNjA=
...
# fmt: off  My80OmFIVnBZMlhva2FQbHNJL21tS1U2YldaRU53PT06NDIxOGJjNjA=
