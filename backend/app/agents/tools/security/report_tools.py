...
# type: ignore  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2U1RoMFRBPT06M2MwMTNjMjU=
...
# noqa  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2U1RoMFRBPT06M2MwMTNjMjU=
...
async def generate_executive_summary(
    ...
    **重要：** 若返回中包含 `object_name`，必须将其传给 `mgmt_save_pentest_report` 的 `file_path` 参数。
    ...
    for finding in findings:
        ...
        if sev in severity_counts:
            severity_counts[sev] += 1
# fmt: off  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2U1RoMFRBPT06M2MwMTNjMjU=
            ...
            for tool_name in ["render_chart", "generate_chart", "chart", "pie"]:
                if tool_name in tool_map:
                    try:
                        ...
                        continue
# type: ignore  My80OmFIVnBZMlhva2FQbHNJL21tS1U2U1RoMFRBPT06M2MwMTNjMjU=
