...
# noqa  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2UXpad1ZnPT06MGQ4Zjg2YTA=
...
# pragma: no cover  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2UXpad1ZnPT06MGQ4Zjg2YTA=
...
def extract_pdf_text(pdf_data: bytes, filename: str = "unknown.pdf", cache: Optional[dict] = None) -> str:
    ...
    try:
        ...
        try:
            ...
            raise  # 继续到备用方法
# pragma: no cover  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2UXpad1ZnPT06MGQ4Zjg2YTA=
        ...
        try:
            ...
            import io
# pylint: disable  My80OmFIVnBZMlhva2FQbHNJL21tS1U2UXpad1ZnPT06MGQ4Zjg2YTA=
