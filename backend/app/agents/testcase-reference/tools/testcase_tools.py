...
# ============ 辅助函数 ============
# pylint: disable  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2TjNSVFNRPT06ZDhjNjc5NTg=
...
async def create_test_case_tool(
    ...
    try:
        ...
        params = None
# pylint: disable  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2TjNSVFNRPT06ZDhjNjc5NTg=
...
async def update_test_case_tool(
    ...
    try:
        # 构建更新数据（只包含提供的字段）
        request_data: dict[str, Any] = {}
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2TjNSVFNRPT06ZDhjNjc5NTg=
...
# pylint: disable  My80OmFIVnBZMlhva2FQbHNJL21tS1U2TjNSVFNRPT06ZDhjNjc5NTg=
