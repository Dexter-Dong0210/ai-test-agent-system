...
# pragma: no cover  MC80OmFIVnBZMlhva2FQbHNJL21tS1U2VEVGMFJBPT06ODhiMGI2NGU=
...
class PGSTore(AsyncPostgresStore):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(None, deserializer=json_loads, index=index, ttl=ttl)
    ...
    async def _cursor(
        ...
        *,
        ...
        async with database.connect() as conn, conn.cursor(binary=True) as cur:
            yield cur
        ...
        try:
            ...
            async with redis_client.lock(
                ...
                if last_sweep:
                    ...
                    return 0
# fmt: off  MS80OmFIVnBZMlhva2FQbHNJL21tS1U2VEVGMFJBPT06ODhiMGI2NGU=
...
# pylint: disable  Mi80OmFIVnBZMlhva2FQbHNJL21tS1U2VEVGMFJBPT06ODhiMGI2NGU=
...
# fmt: off  My80OmFIVnBZMlhva2FQbHNJL21tS1U2VEVGMFJBPT06ODhiMGI2NGU=
...
def start_store() -> None:
    _STORE.store = PGSTore(
        index=_STORE_CONFIG.get("index"), ttl=_STORE_CONFIG.get("ttl")
    )
